                        ...
                        <form method="post" class="needs-validation">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <input type="text" class="form-control" value="{{ $real->fullNames}}">
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="text" name="username" class="form-control" value="{{ $real->username}}">
                                <div class="invalid-feedback">
                                    Please fill in the email
                                </div>
                                </div>
                                <div class="form-group col-md-5 col-12">
                                <label>Phone</label>
                                <input type="tel" class="form-control" value="{{ $real->phone}}">
                                </div>
                            </div>
                            <div class="row">
